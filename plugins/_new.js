let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `-Naked-flex bot🎉 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙎𝙐𝙋𝙋𝙊𝙍𝙏\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:*https://whatsapp.com/channel/0029Vb2TSDd47XeCsqaFak1o\n\n ${Config.botname} *©PETER*`;
...
smd(
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*-X-:bot CURRENTLY ACTIVE!*";
 ...
 smd({
   ...
   try {
     let _0x45fa91 = await fetch("https://api.giftedtech.my.id/api/fun/shayari?apikey=gifted");
     let {
       result: _0x1aa994
 ...
 smd({
   ...
   try {
     ...
     if (!_0x587b99) {
       return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://github.com/Mek-d1/X-bot*");
     }
