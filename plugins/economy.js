...
let ty = false ; 
  ...
  try {
   ...
   // else{ try{ ty = eco.connect("mongodb+srv://mohsin:mohsin@cluster0.iauaztt.mongodb.net/?retryWrites=true&w=majority") ; console.log("Connected with discord economy!!") }catch(e){console.log("eco Mongose error : " , e)} }
